...
public class SplashScreen extends Activity {
  ...
  public void onCreate(Bundle icicle) {
    ...
    try {
      ...
      APPGlobalVars.SCR_PAUSE_CTL = "";
          ...
          Intent i = new Intent(SplashScreen.this, Music_List.class);
          startActivity(i);
  ...
  protected void onDestroy() {
    ...
    try {
      ...
      MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(
          SplashScreen.this);
      errExcpError.addToLogFile(error, "SplashScreen..onDestroy", "no alert");
      errExcpError = null;
      return;
    }// end try/catch (Exception error)
  ...
  protected void onPause() {
    ...
    try {
      ...
      MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(
          SplashScreen.this);
      errExcpError.addToLogFile(error, "SplashScreen.onPause", "no alert");
      errExcpError = null;
    }// end try/catch (Exception error)
  ...
  protected void onStop() {
    ...
    try {
      ...
      MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(
          SplashScreen.this);
      errExcpError.addToLogFile(error, "SplashScreen.onStop", "no alert");
      errExcpError = null;
    }// end try/catch (Exception error)
  }// end onStop
